    ...
    'resources' => [
        'scripts' => [
            ...
            'modernizr' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/modernizr/modernizr.min.js',
            ...
            'respond' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/respond.min.js',
                ],
            ],
            'excanvas' => [
                'use_cdn' => false,
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/excanvas.min.js',
                ],
            ],
            'ie8-fix' => [
                'use_cdn' => false,
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/ie8.fix.min.js',
                ],
            ],
            'counterup' => [
                'use_cdn' => false,
                ...
                'src' => [
                    'local' => [
                        '/vendor/core/base/libraries/counterup/jquery.counterup.min.js',
                    ],
                ],
            ],
            'jquery-validation' => [
            ...
            'cookie' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/jquery-cookie/jquery.cookie.js',
            ...
            'jqueryTree' => [
                ...
                'include_style' => true,
                'src' => [
                    'local' => '/vendor/core/base/libraries/jquery-tree/jquery.tree.min.js',
                ],
            ],
            'bootstrap-editable' => [
                'use_cdn' => true,
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/bootstrap3-editable/js/bootstrap-editable.min.js',
            ...
            'pace' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/pace/pace.min.js',
            ...
            'raphael' => [
                ...
                'src' => [
                    'local' => [
                        '/vendor/core/base/libraries/raphael-min.js',
                    ],
                ],
            ],
            'morris' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/morris/morris.min.js',
            ...
            'equal-height' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/jQuery.equalHeights/jquery.equalheights.min.js',
                ],
            ],
            'are-you-sure' => [
                'use_cdn' => false,
            ...
            'jquery-waypoints' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/jquery-waypoints/jquery.waypoints.min.js',
                ],
            ],
            'colorpicker' => [
                'use_cdn' => false,
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js',
                ],
            ],
            'timepicker' => [
                'use_cdn' => false,
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/bootstrap-timepicker/js/bootstrap-timepicker.min.js',
                ],
            ],
            'spectrum' => [
                'use_cdn' => false,
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/spectrum/spectrum.js',
                ],
            ],
            'input-mask' => [
                'use_cdn' => false,
            ...
            'apexchart' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/apexchart/apexcharts.min.js',
                ],
            ],
            // End JS
        ],
        ...
        'styles' => [
            ...
            'jqueryTree' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/jquery-tree/jquery.tree.min.css',
                ],
            ],
            'jquery-ui' => [
                'use_cdn' => true,
            ...
            'kendo' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/kendo/kendo.min.css',
                ],
            ],
            'datatables' => [
                'use_cdn' => false,
            ...
            'bootstrap-editable' => [
                ...
                'location' => 'footer',
                'src' => [
                    'local' => '/vendor/core/base/libraries/bootstrap3-editable/css/bootstrap-editable.css',
            ...
            'morris' => [
                ...
                'location' => 'header',
                'src' => [
                    'local' => '/vendor/core/base/libraries/morris/morris.css',
            ...
            'colorpicker' => [
                ...
                'location' => 'header',
                'src' => [
                    'local' => '/vendor/core/base/libraries/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css',
                ],
            ],
            'timepicker' => [
                'use_cdn' => false,
                'location' => 'header',
                'src' => [
                    'local' => '/vendor/core/base/libraries/bootstrap-timepicker/css/bootstrap-timepicker.min.css',
                ],
            ],
            'spectrum' => [
                'use_cdn' => false,
                'location' => 'header',
                'src' => [
                    'local' => '/vendor/core/base/libraries/spectrum/spectrum.css',
                ],
            ],
            'apexchart' => [
                'use_cdn' => false,
                'location' => 'header',
                'src' => [
                    'local' => '/vendor/core/base/libraries/apexchart/apexcharts.css',
                ],
            ],
        ],
    ],
