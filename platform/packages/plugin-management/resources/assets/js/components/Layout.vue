<template>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <ul class="nav nav-pills">
                        <li
                            v-for="(item, index) in ['all', 'featured', 'popular', 'top_rated']"
                            class="nav-item"
                            :key="index"
                        >
                            <a class="nav-link" @click="changeTab(item)" :class="{ active: tab === item }">
                                {{ __('base.' + item) }}
                                <span v-show="tab === item">({{ pagination.total }})</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div v-else class="card-body text-center">
            ...
            <p class="fw-lighter">
                {{ __('base.connection_aborted_description') }}
            </p>
