<li class="relative md:flex md:flex-1">
    @if ((Request::is('install') || Request::is('install/requirements') || Request::is('install/environment') || Request::is('install/environment/save')) && $currentStep !== 2)
        <a href="{{ URL::signedRoute('installers.requirements', [], \Carbon\Carbon::now()->addMinutes(30)) }}" class="group flex w-full items-center">
            <span class="flex items-center px-6 py-4 text-sm font-medium">
                ...
                <span class="ms-4 text-sm font-medium text-indigo-600">{{ trans('packages/installer::installer.requirements.title') }}</span>
                ...
                @else
                    ...
                    <span class="ms-4 text-sm font-medium text-gray-900">{{ trans('packages/installer::installer.requirements.title') }}</span>
                @endif
            </span>
        </a>
    @else
