<li class="relative md:flex md:flex-1">
    @if ((Request::is('install/environment/save') || Request::is('install/account') || Request::is('install/account/save')) && $currentStep !== 4)
        <a href="{{ URL::signedRoute('installers.create_account', [], \Carbon\Carbon::now()->addMinutes(30)) }}" class="group flex w-full items-center disable">
                                <span class="flex items-center px-6 py-4 text-sm font-medium">
                                    @if ($currentStep == 4)
                                        ...
                                        <span class="ms-4 text-sm font-medium text-indigo-600">{{ trans('packages/installer::installer.create_account') }}</span>
                                    ...
                                    @else
                                        ...
                                        <span class="ms-4 text-sm font-medium text-gray-900">{{ trans('packages/installer::installer.create_account') }}</span>
                                    @endif
                                </span>
        </a>
    @else
